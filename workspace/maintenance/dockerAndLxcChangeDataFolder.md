...
> :warning: **Важно**
 Если у работают контейнеры ***Логин Центра Оптимакрос***, то останавливать их нужно командой `./om stop` из директории с установленным LC
